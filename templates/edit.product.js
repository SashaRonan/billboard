(function (app) {
    app.EditProduct = {  // Создание HTML формы для редактирования товара
        ...
        draw: function (
            ...
            let button_edit                  = app.Create.buttonWithID('edit_button', 'save_' + productID, 'Сохранить', app.Functions.saveUpdateProduct)
            let button_delete                = app.Create.buttonWithID('edit_button', "del_" + productID, 'Удалить', app.Functions.deleteProduct)
