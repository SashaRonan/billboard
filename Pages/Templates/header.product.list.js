(function (app) {
    app.HeaderProductList = {  // Создание HTML страницы для хедера после авторизации пользователя
        ...
        draw: function () {
            ...
            let headerNavList                     = app.Create.button('header_a',"Лента", app.Navigate.goToProductList);
            let headerNavMyAds                    = app.Create.button('header_a',"Мои объявления", app.Navigate.goToMyProducts );
            let headerNavExit                     = app.Create.button('header_a', "Выход", app.User.LogOut );
